...
const Footer = () => {
  ...
  function openWhatsApp() {
    ...
    const message = "السلام عليكم عندي استفسار بخصوص سيارة"; // الرسالة التي تريد إرسالها
  ...
  return (
    // <div className="   grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 justify-center p-5    bg-[#282828] rtl ">

    //   <div className="flex    flex-col items  -end gap-3 ">
    //     <h1 className="font-graphik-arabicbb text-white">:العنوان</h1>
    //     <h1 className="font-graphik-arabicm text-white">
    //       {" "}
